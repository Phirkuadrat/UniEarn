<nav x-cloak
    ...
    <!-- logo  -->
    <a href="#" class="ml-2 py-5 w-fit text-2xl font-bold text-on-surface-strong dark:text-on-surface-dark-strong">
    ...
    <div class="flex flex-col gap-2 overflow-y-auto pb-6 ">
        ...
        <a href="#"
            class="flex items-center rounded-radius gap-2 px-12 py-4 text-sm font-medium text-on-surface underline-offset-2 hover:bg-primary/5 hover:text-on-surface-strong focus-visible:underline focus:outline-hidden dark:text-on-surface-dark dark:hover:bg-primary-dark/5 dark:hover:text-on-surface-dark-strong">
