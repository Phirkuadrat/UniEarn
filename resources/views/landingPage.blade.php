...
<body class="bg-white text-gray-800 font-[montserrat] scroll-smooth">
    ...
    <!-- Hero Section -->
    <section
        class="bg-[url({{ asset('images/fotoHero.webp') }})] bg-cover bg-center py-48 justify-end items-center flex">
                ...
                <div class="flex overflow-x-auto space-x-6 p-4 scroll-smooth snap-x snap-mandatory">
                    <div action=""
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-pretty text-gray-600 ">Pengembangan website, pengembangan software, pengembangan
                                game.</p>
                        </div>
                    </div>
                    <div action=""
