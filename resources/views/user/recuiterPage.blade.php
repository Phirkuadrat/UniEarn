<x-landing-layout>
    ...
    <body>
        ...
        <!-- Hero Section -->
        <section
            style="background-image: url('{{ asset('images/heroforrecuiter.webp') }}')"
            ...
            <div
                ...
                <h1 class="text-6xl font-bold mb-4 text-[#3674B5]">Kamu mencari pekerja?</h1>
                <h2 class="text-7xl font-bold mb-4 text-black">Jadilah Recuiter!</h2>
                <p class="text-4xl text-gray-600 mb-6">Dukung potensi mereka dengan kami.</p>
                {{-- <button></button> --}}
        ...
        <section id="fitur" class="py-16 bg-[#F2FAFC]">
            <div class=" mx-auto px-4">
                <h3 class="text-3xl font-bold text-center mb-10">Kamu butuh siapa?</h3>
        ...
        <section id="pekerja" class="py-16 bg-white">
            <div class="mx-auto px-4 max-w-7xl">
                <h3 class="text-3xl font-bold text-center mb-10">Pekerja Terfavorit</h3>
                <div class="flex justify-center items-center space-x-6">
                    <div class="flex flex-col min-w-48 max-w-56 h-56 bg-[#FCFEFC] px-8 py-10 rounded-sm shadow-md">
                        <div class="flex flex-row mb-4 items-center">
                            ...
                            <div class="ml-4">
                                <h4 class="text-xl font-semibold">Agus</h4>
                            </div>
                        </div>
